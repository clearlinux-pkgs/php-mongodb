...
Source0  : https://pecl.php.net/get/mongodb-1.17.2.tgz
...
%prep
%setup -q -n mongodb-1.17.2
cd %{_builddir}/mongodb-1.17.2
pushd ..
cp -a mongodb-1.17.2 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/extensions/no-debug-non-zts-20230831/mongodb.so
